      ...
      <section id="features" className="py-20 bg-comp-mauve text-center">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="feature-item p-6 bg-dark-brown rounded-lg shadow-lg">
            <img src="/images/feature1-icon.png" alt="Track Your Meals" className="mx-auto mb-4 h-20 w-20" />
          ...
          <div className="feature-item p-6 bg-dark-brown rounded-lg shadow-lg">
            <img src="/images/feature2-icon.png" alt="Personalized Goals" className="mx-auto mb-4 h-20 w-20" />
          ...
          <div className="feature-item p-6 bg-dark-brown rounded-lg shadow-lg">
            <img src="/images/feature3-icon.png" alt="Easy to Use" className="mx-auto mb-4 h-20 w-20" />
